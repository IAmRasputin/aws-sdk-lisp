...
(common-lisp:progn
 (common-lisp:defclass pinpoint-email-request (aws-sdk/request:request)
                       common-lisp:nil
                       (:default-initargs :service "pinpoint-email" :protocol
                        :rest-json))
...
(common-lisp:progn
 ...
 (common-lisp:defun make-create-configuration-set-request
                    (
                     common-lisp:&rest aws-sdk/generator/shape::args
                     common-lisp:&key tags sending-options reputation-options
                     delivery-options tracking-options configuration-set-name)
   (common-lisp:apply #'common-lisp:make-instance
...
(common-lisp:progn
 ...
 (common-lisp:defun make-create-dedicated-ip-pool-request
                    (
                     common-lisp:&rest aws-sdk/generator/shape::args
                     common-lisp:&key tags pool-name)
   (common-lisp:apply #'common-lisp:make-instance
...
(common-lisp:progn
 ...
 (common-lisp:defun make-create-email-identity-request
                    (
                     common-lisp:&rest aws-sdk/generator/shape::args
                     common-lisp:&key tags email-identity)
   (common-lisp:apply #'common-lisp:make-instance
...
(common-lisp:progn
 ...
 (common-lisp:defun make-dkim-attributes
                    (
                     common-lisp:&rest aws-sdk/generator/shape::args
                     common-lisp:&key tokens status signing-enabled)
...
(common-lisp:progn
 ...
 (common-lisp:defun make-get-account-response
                    (
                     ...
                     enforcement-status dedicated-ip-auto-warmup-enabled
                     sending-enabled send-quota)
...
(common-lisp:progn
 ...
 (common-lisp:defun make-get-email-identity-response
                    (
                     common-lisp:&rest aws-sdk/generator/shape::args
                     common-lisp:&key tags mail-from-attributes dkim-attributes
                     verified-for-sending-status feedback-forwarding-status
                     identity-type)
...
(common-lisp:progn
 ...
 (common-lisp:defun make-identity-info
                    (
                     common-lisp:&rest aws-sdk/generator/shape::args
                     common-lisp:&key sending-enabled identity-name
                     identity-type)
...
(common-lisp:progn
 ...
 (common-lisp:defun make-send-email-request
                    (
                     common-lisp:&rest aws-sdk/generator/shape::args
                     common-lisp:&key configuration-set-name email-tags content
                     feedback-forwarding-email-address reply-to-addresses
                     destination from-email-address)
...
(common-lisp:progn
 ...
 (common-lisp:defun make-template
                    (
                     common-lisp:&rest aws-sdk/generator/shape::args
                     common-lisp:&key template-data template-arn)
   ...
   (aws-sdk/generator/operation::parse-response
    (aws-sdk/api:aws-request
     (common-lisp:make-instance 'pinpoint-email-request :method "GET" :path
                                "/v1/email/account" :protocol :rest-json
...
(common-lisp:progn
 (common-lisp:defun get-deliverability-dashboard-options ()
   (aws-sdk/generator/operation::parse-response
    (aws-sdk/api:aws-request
     (common-lisp:make-instance 'pinpoint-email-request :method "GET" :path
                                "/v1/email/deliverability-dashboard" :protocol
                                :rest-json :operation
