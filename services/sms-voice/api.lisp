...
(common-lisp:progn
 (common-lisp:defclass sms-voice-request (aws-sdk/request:request)
                       common-lisp:nil
                       (:default-initargs :service "sms-voice" :protocol
                        :rest-json))
...
(common-lisp:progn
 (common-lisp:defclass list-configuration-sets-response common-lisp:nil
                       ((next-token :initarg :next-token :type
                         ...
                         :accessor %list-configuration-sets-response-next-token
                         :initform common-lisp:nil)
